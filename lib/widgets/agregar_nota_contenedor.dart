...
class AgregarNotaContenedor extends StatelessWidget {
  const AgregarNotaContenedor({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Container(
        height: screenAlto * 0.65,
        width: screenAncho * 0.9,
